...
return [
    ...
    'info' => [
         ...
         */
        'description' => 'Interactive API documentation for the e-libra backend. Use the login endpoint to get a bearer token, then click Authorize and paste it to test protected routes.',
    ],
